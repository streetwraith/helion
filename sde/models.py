...
class SdeTypeId(models.Model):
    ...
    market_group_id = models.IntegerField(db_index=True, default=None, blank=True, null=True)
...
class MarketGroup(models.Model):
    ...
    parent_group_id = models.IntegerField(db_index=True, default=None, blank=True, null=True)
    def __str__(self):
...
class NpcCorporation(models.Model):
    ...
    faction_id = models.IntegerField(default=None, blank=True, null=True)
