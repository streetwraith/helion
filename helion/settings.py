...
# Each request rewrites the expiry, so a session in use never runs out.
...
# ESI fetch scheduler failure policy.
ESI_FETCH_DISABLE_AFTER = env.int('ESI_FETCH_DISABLE_AFTER', default=3)
ESI_FETCH_BACKOFF_BASE_SECONDS = env.int('ESI_FETCH_BACKOFF_BASE_SECONDS', default=120)
ESI_FETCH_BACKOFF_CAP_SECONDS = env.int('ESI_FETCH_BACKOFF_CAP_SECONDS', default=3600)
