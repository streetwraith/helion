...
made, what each wormhole gas site pays for the fleet you fly, loyalty-point store payouts, shopping lists you can name and keep, a browser for one item's full order book across the ingested regions, a tracker for your courier and item-exchange contracts, a list of everything your characters and corporation own and where it sits, and a history of your own transactions and profits. A reference page lists every published ship hull with its slot layout, its resist profile, its flight and fitting figures and its trait bonuses, read from the static data on each request. Price alerts watch any item against a threshold and show up on a bar across every page. The header carries the ISK of every tracked wallet as
